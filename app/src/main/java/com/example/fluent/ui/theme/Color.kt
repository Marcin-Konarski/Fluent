...
val OceanBlue = Color(0xFF0288D1)      // Deep ocean blue
val NeonBlue = Color(0xFF00E5FF)       // Vibrant neon blue
val ElectricBlue = Color(0xFF2962FF)   // High-energy electric blue
val DeepBlue = Color(0xFF0D47A1)       // Deep midnight blue
...
val CandyPink = Color(0xFFFF4081)      // Bright candy pink
val NeonPink = Color(0xFFFF1493)       // Striking neon pink
val HotPink = Color(0xFFFF007F)        // Bold hot pink
...
val DeepMagenta = Color(0xFF8E24AA)    // Elegant deep magenta
val NeonMagenta = Color(0xFFFF00FF)    // Bright neon magenta
...
val Turquoise = Color(0xFF40E0D0)      // Tropical turquoise
val EmeraldGreen = Color(0xFF00C853)   // Rich emerald green
val JadeGreen = Color(0xFF00A676)      // Deep jade green
...
val OffWhite = Color(0xFFF5F5F5)       // Soft white for backgrounds

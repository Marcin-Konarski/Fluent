...
import com.example.fluent.ui.components.BottomBarTab
import com.example.fluent.ui.components.tabs
...
fun BlurredAppNavigationBar(
    ...
    val currentRoute = navBackStackEntry?.destination?.route ?: Screen.Screen1.route
